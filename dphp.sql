...
INSERT INTO `dp_admin_action` VALUES (2, 'user', 'user_edit', 'Edit用户', 'Edit用户', '', '[user|get_nickname] Edit了用户：[details]', 1, 1480164578, 1480297748);
INSERT INTO `dp_admin_action` VALUES (3, 'user', 'user_delete', 'Delete用户', 'Delete用户', '', '[user|get_nickname] Delete了用户：[details]', 1, 1480168582, 1480168616);
...
INSERT INTO `dp_admin_action` VALUES (8, 'user', 'role_edit', 'Edit角色', 'Edit角色', '', '[user|get_nickname] Edit了角色：[details]', 1, 1480252369, 1480252369);
INSERT INTO `dp_admin_action` VALUES (9, 'user', 'role_delete', 'Delete角色', 'Delete角色', '', '[user|get_nickname] Delete了角色：[details]', 1, 1480252580, 1480252580);
...
INSERT INTO `dp_admin_action` VALUES (14, 'user', 'attachment_delete', 'Delete附件', 'Delete附件', '', '[user|get_nickname] Delete了附件：附件ID([details])', 1, 1480253323, 1480253323);
INSERT INTO `dp_admin_action` VALUES (15, 'admin', 'config_add', '添加配置', '添加配置', '', '[user|get_nickname] 添加了配置，[details]', 1, 1480296196, 1480296196);
INSERT INTO `dp_admin_action` VALUES (16, 'admin', 'config_edit', 'Edit配置', 'Edit配置', '', '[user|get_nickname] Edit了配置：[details]', 1, 1480296960, 1480296960);
...
INSERT INTO `dp_admin_action` VALUES (19, 'admin', 'config_delete', 'Delete配置', 'Delete配置', '', '[user|get_nickname] Delete了配置：[details]', 1, 1480298532, 1480298532);
...
INSERT INTO `dp_admin_action` VALUES (24, 'admin', 'database_backup_delete', 'Delete数据库备份', 'Delete数据库备份', '', '[user|get_nickname] Delete了数据库备份：[details]', 1, 1480302870, 1480302870);
INSERT INTO `dp_admin_action` VALUES (25, 'admin', 'hook_add', '添加钩子', '添加钩子', '', '[user|get_nickname] 添加了钩子：[details]', 1, 1480303198, 1480303198);
INSERT INTO `dp_admin_action` VALUES (26, 'admin', 'hook_edit', 'Edit钩子', 'Edit钩子', '', '[user|get_nickname] Edit了钩子：[details]', 1, 1480303229, 1480303229);
INSERT INTO `dp_admin_action` VALUES (27, 'admin', 'hook_delete', 'Delete钩子', 'Delete钩子', '', '[user|get_nickname] Delete了钩子：[details]', 1, 1480303264, 1480303264);
...
INSERT INTO `dp_admin_action` VALUES (31, 'admin', 'menu_edit', 'Edit节点', 'Edit节点', '', '[user|get_nickname] Edit了节点：[details]', 1, 1480305513, 1480305513);
INSERT INTO `dp_admin_action` VALUES (32, 'admin', 'menu_delete', 'Delete节点', 'Delete节点', '', '[user|get_nickname] Delete了节点：[details]', 1, 1480305562, 1480305562);
...
INSERT INTO `dp_admin_config` VALUES (7, 'web_site_copyright', '版权信息', 'base', 'text', ' ', '', '调用方式：<code>config(\'web_site_copyright\')</code>', '', '', '', '', '', 2, '', '', '', '', 1475241416, 1477710383, 8, 1);
...
INSERT INTO `dp_admin_hook` VALUES (14, 'user_edit', '', 'Edit用户钩子', 1, 1503633591, 1503633591, 1);
INSERT INTO `dp_admin_hook` VALUES (15, 'user_delete', '', 'Delete用户钩子', 1, 1503633591, 1503633591, 1);
...
INSERT INTO `dp_admin_log` VALUES (7, 8, 1, 0, 'admin_role', 2, '超级管理员 Edit了角色：user', 1, 1524281495);
INSERT INTO `dp_admin_log` VALUES (8, 2, 1, 0, 'admin_user', 3, '超级管理员 Edit了用户：字段(role)，原值(1)，新值：(2)', 1, 1524281523);
INSERT INTO `dp_admin_log` VALUES (9, 7, 1, 0, 'admin_role', 3, '超级管理员 添加了角色：Manager', 1, 1524291162);
INSERT INTO `dp_admin_log` VALUES (10, 8, 1, 0, 'admin_role', 3, '超级管理员 Edit了角色：字段(access)，原值(0)，新值：(true)', 1, 1524291174);
INSERT INTO `dp_admin_log` VALUES (11, 2, 1, 0, 'admin_user', 2, '超级管理员 Edit了用户：字段(role)，原值(1)，新值：(3)', 1, 1524291189);
INSERT INTO `dp_admin_log` VALUES (12, 2, 1, 0, 'admin_user', 2, '超级管理员 Edit了用户：字段(role)，原值(3)，新值：(1)', 1, 1524291197);
INSERT INTO `dp_admin_log` VALUES (13, 8, 1, 0, 'admin_role', 3, '超级管理员 Edit了角色：Manager', 1, 1524291210);
INSERT INTO `dp_admin_log` VALUES (14, 8, 1, 0, 'admin_role', 3, '超级管理员 Edit了角色：Manager', 1, 1524291262);
INSERT INTO `dp_admin_log` VALUES (15, 2, 1, 0, 'admin_user', 3, '超级管理员 Edit了用户：字段(role)，原值(2)，新值：(1)', 1, 1524291342);
INSERT INTO `dp_admin_log` VALUES (16, 8, 1, 0, 'admin_role', 2, '超级管理员 Edit了角色：user', 1, 1524291374);
INSERT INTO `dp_admin_log` VALUES (17, 8, 1, 0, 'admin_role', 2, '超级管理员 Edit了角色：user', 1, 1524291382);
...
INSERT INTO `dp_admin_log` VALUES (20, 2, 1, 0, 'admin_user', 3, '超级管理员 Edit了用户：字段(role)，原值(1)，新值：(2)', 1, 1524319668);
INSERT INTO `dp_admin_log` VALUES (21, 8, 1, 0, 'admin_role', 2, '超级管理员 Edit了角色：user', 1, 1524319698);
INSERT INTO `dp_admin_log` VALUES (22, 8, 1, 0, 'admin_role', 2, '超级管理员 Edit了角色：user', 1, 1524319747);
INSERT INTO `dp_admin_log` VALUES (23, 2, 1, 0, 'admin_user', 3, '超级管理员 Edit了用户：user', 1, 1524319773);
INSERT INTO `dp_admin_log` VALUES (24, 2, 1, 0, 'admin_user', 2, '超级管理员 Edit了用户：字段(role)，原值(1)，新值：(3)', 1, 1524319899);
INSERT INTO `dp_admin_log` VALUES (25, 2, 1, 0, 'admin_user', 2, '超级管理员 Edit了用户：manager', 1, 1524319913);
INSERT INTO `dp_admin_log` VALUES (26, 8, 1, 0, 'admin_role', 3, '超级管理员 Edit了角色：Manager', 1, 1524319938);
COMMIT;
...
CREATE TABLE `dp_admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=371 DEFAULT CHARSET=utf8 COMMENT='后台菜单表';
...
INSERT INTO `dp_admin_menu` VALUES (10, 7, 'admin', 'Delete', '', 'module_admin', 'admin/config/delete', '_self', 0, 1467619583, 1477710695, 3, 1, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (14, 13, 'admin', 'Create', '', 'module_admin', 'admin/menu/add', '_self', 0, 1467619902, 1477710695, 1, 1, 1, '');
INSERT INTO `dp_admin_menu` VALUES (15, 13, 'admin', 'Edit', '', 'module_admin', 'admin/menu/edit', '_self', 0, 1467620331, 1477710695, 2, 1, 1, '');
INSERT INTO `dp_admin_menu` VALUES (16, 13, 'admin', 'Delete', '', 'module_admin', 'admin/menu/delete', '_self', 0, 1467620363, 1477710695, 3, 1, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (21, 20, 'user', 'Create', '', 'module_admin', 'user/index/add', '_self', 0, 1467688177, 1477710702, 1, 1, 1, '');
INSERT INTO `dp_admin_menu` VALUES (22, 20, 'user', 'Edit', '', 'module_admin', 'user/index/edit', '_self', 0, 1467688202, 1477710702, 2, 1, 1, '');
INSERT INTO `dp_admin_menu` VALUES (23, 20, 'user', 'Delete', '', 'module_admin', 'user/index/delete', '_self', 0, 1467688219, 1477710702, 3, 1, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (55, 50, 'admin', 'Delete', '', 'module_admin', 'admin/attachment/delete', '_self', 0, 1467690396, 1477710695, 5, 1, 1, '');
INSERT INTO `dp_admin_menu` VALUES (56, 41, 'admin', 'Delete', '', 'module_admin', 'admin/plugin/delete', '_self', 0, 1467858065, 1477710695, 11, 1, 1, '');
INSERT INTO `dp_admin_menu` VALUES (57, 41, 'admin', 'Edit', '', 'module_admin', 'admin/plugin/edit', '_self', 0, 1467858092, 1477710695, 10, 1, 1, '');
INSERT INTO `dp_admin_menu` VALUES (60, 41, 'admin', 'Create', '', 'module_admin', 'admin/plugin/add', '_self', 0, 1467858421, 1477710695, 9, 1, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (71, 67, 'user', 'Create', '', 'module_admin', 'user/role/add', '_self', 0, 1476256935, 1477710702, 1, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (72, 67, 'user', 'Edit', '', 'module_admin', 'user/role/edit', '_self', 0, 1476256968, 1477710702, 2, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (73, 67, 'user', 'Delete', '', 'module_admin', 'user/role/delete', '_self', 0, 1476256993, 1477710702, 3, 0, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (77, 69, 'admin', 'Create', '', 'module_admin', 'admin/hook/add', '_self', 0, 1476668971, 1477710695, 1, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (78, 69, 'admin', 'Edit', '', 'module_admin', 'admin/hook/edit', '_self', 0, 1476669006, 1477710695, 2, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (79, 69, 'admin', 'Delete', '', 'module_admin', 'admin/hook/delete', '_self', 0, 1476669375, 1477710695, 3, 0, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (186, 185, 'admin', 'Create', '', 'module_admin', 'admin/action/add', '_self', 0, 1476884439, 1477710695, 1, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (187, 185, 'admin', 'Edit', '', 'module_admin', 'admin/action/edit', '_self', 0, 1476884464, 1477710695, 2, 0, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (190, 185, 'admin', 'Delete', '', 'module_admin', 'admin/action/delete', '_self', 0, 1476884551, 1477710695, 5, 0, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (195, 65, 'admin', 'Delete备份', '', 'module_admin', 'admin/database/delete', '_self', 0, 1476973457, 1477710695, 5, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (210, 41, 'admin', '快速Edit', '', 'module_admin', 'admin/plugin/quickedit', '_self', 0, 1477713981, 1477713981, 100, 0, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (216, 215, 'user', 'Create', '', 'module_admin', 'user/message/add', '_self', 0, 1520492195, 1520492195, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (217, 215, 'user', 'Edit', '', 'module_admin', 'user/message/edit', '_self', 0, 1520492195, 1520492195, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (218, 215, 'user', 'Delete', '', 'module_admin', 'user/message/delete', '_self', 0, 1520492195, 1520492195, 100, 0, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (226, 225, 'admin', 'Create', '', 'module_admin', 'admin/icon/add', '_self', 0, 1520908295, 1520908295, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (227, 225, 'admin', 'Edit', '', 'module_admin', 'admin/icon/edit', '_self', 0, 1520908295, 1520908295, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (228, 225, 'admin', 'Delete', '', 'module_admin', 'admin/icon/delete', '_self', 0, 1520908295, 1520908295, 100, 0, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (231, 225, 'admin', '快速Edit', '', 'module_admin', 'admin/icon/quickedit', '_self', 0, 1520908295, 1520908295, 100, 0, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (364, 363, 'odc', 'Create', '', 'module_admin', 'odc/product/add', '_self', 0, 1524312451, 1524312451, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (365, 363, 'odc', 'Edit', '', 'module_admin', 'odc/product/edit', '_self', 0, 1524312451, 1524312451, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (366, 363, 'odc', 'Delete', '', 'module_admin', 'odc/product/delete', '_self', 0, 1524312451, 1524312451, 100, 0, 1, '');
...
INSERT INTO `dp_admin_menu` VALUES (368, 367, 'odc', 'Create', '', 'module_admin', 'odc/inventory/add', '_self', 0, 1524312451, 1524312451, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (369, 367, 'odc', 'Edit', '', 'module_admin', 'odc/inventory/edit', '_self', 0, 1524312451, 1524312451, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (370, 367, 'odc', 'Delete', '', 'module_admin', 'odc/inventory/delete', '_self', 0, 1524312451, 1524312451, 100, 0, 1, '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `dp_admin_module` VALUES (1, 'admin', '系统', 'fa fa-fw fa-gear', '系统模块，PHP的核心模块', 'PHP', '', '', '', '1.0.0', 'admin.PHP.module', 1, 1468204902, 1468204902, 100, 1);
INSERT INTO `dp_admin_module` VALUES (2, 'user', '用户', 'fa fa-fw fa-user', '用户模块，PHP自带模块', 'PHP', '', '', '', '1.0.0', 'user.PHP.module', 1, 1468204902, 1468204902, 100, 1);
...
INSERT INTO `dp_admin_plugin` VALUES (3, 'AliyunSms', '阿里云短信发送插件', 'fa fa-fw fa-commenting', '阿里云短信发送插件', 'jing', 'http://www.yunqinet.com', '{\"AppKey\":\"\",\"AppSecret\":\"\",\"SignName\":\"\",\"TemplateCode\":\"\"}', '1.0.0', 'aliyunsms.jing.plugin', 0, 1523596749, 1523596749, 100, 1);
COMMIT;
...
INSERT INTO `dp_admin_user` VALUES (2, 'manager', 'manager', '$2y$10$CQxBECVWuOBu.Sfs2hSOp.aP0ncAuVjfEskEnXywJu9AzpsXGTaxq', 'manager@qq.com', 0, '', 0, 0, 0.00, 0, 3, 0, 0, 1524281188, 1524319958, 1524319958, 0, 100, 1);
INSERT INTO `dp_admin_user` VALUES (3, 'user', 'user', '$2y$10$MG/UxznRLRLc8gclOsVY9uM5Ko6sjH4b0scxcaXPa.FDk1Boan1fi', 'user@qq.com', 0, '', 0, 0, 0.00, 0, 2, 0, 0, 1524281216, 1524319801, 1524319800, 0, 100, 1);
...
-- ----------------------------
BEGIN;
INSERT INTO `dp_odc_category` VALUES (0, 0, 3, '顶级分类', '', NULL, 1, NULL, NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `dp_odc_product` VALUES (1, 'qqqqq', 2, 3, 'qq', 0, 'qq', 0, 'qqqqq222', b'1', 1524236861, 1524236918);
INSERT INTO `dp_odc_product` VALUES (2, '休闲双肩包', 7, 3, 'red', 10, '', 0, '', b'1', 1524279462, 1524279462);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `dp_odc_user` VALUES (1, 1, 9, NULL, 1, NULL, NULL);
INSERT INTO `dp_odc_user` VALUES (2, 2, 11, NULL, 1, NULL, NULL);
INSERT INTO `dp_odc_user` VALUES (3, 3, 11, NULL, 0, NULL, NULL);
INSERT INTO `dp_odc_user` VALUES (4, 4, NULL, NULL, NULL, 1524324620, 1524324620);
INSERT INTO `dp_odc_user` VALUES (5, 5, 4, NULL, NULL, 1524324807, 1524324807);
COMMIT;
