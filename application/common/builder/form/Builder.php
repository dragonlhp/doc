...
class Builder extends ZBuilder
{
    ...
    private $_vars = [
        ...
        '_method'         => 'post',// 表单提交方式
        'empty_tips'      => 'Not Datas',// 没有表单项时的提示信息
    ];
     ...
     * @param string $title 标题
     * @param string $tips 提示
     * @param string $width Edit器宽度，默认100%
     * @param integer $height Edit器高度，默认400px
     * @param string $default 默认值
     * @param string $extra_class 额外css类名
     ...
     * @param string $tips 提示
     * @param string $default 默认值
     * @param string $width Edit器宽度
     * @param int $height Edit器高度
    ...
    /**
     * 设置Tab按钮列表
     * @param array $tab_list Tab列表 如：['tab1' => ['title' => '标题', 'url' => '']]
